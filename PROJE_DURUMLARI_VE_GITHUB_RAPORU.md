...
Bu rapor, tüm aktif yazılım projelerinizi **Açık Kaynak (Public)** ve **Özel Ar-Ge (Private)** olarak iki ayrı kategoride listeler.
...
| :--- | :---: | :--- |
| 🌐 **Açık Kaynak (Public) Depolar** | **17** | GitHub üzerinde herkese açık, incelenebilir ve %100 güncel. |
| 🔒 **Özel Ar-Ge (Private) Depolar** | **6** | Gizli depolarda korunan, tam senkronize ve yedekli. |
| **Toplam Aktif Yazılım Projesi** | **23** | **Tümü GitHub'da yayında ve eksiksiz.** |

---

## 🌐 1. Açık Kaynak / Genel (Public) Projeler

Bu projeler GitHub profilinizde ve portfolyonuzda ziyaretçiler/işverenler tarafından doğrudan incelenebilir:

| # | Proje Adı | Açıklama & Teknoloji | Portfolyoda Var mı? | GitHub Depo Linki | Durum |
| :-: | :--- | :--- | :-: | :--- | :---: |
...
| **20** | **Fare Oyunu** | Python / Pygame Etkileşimli Oyun | ❌ Hayır | [oguztasdemir/Fare-Oyunu](https://github.com/oguztasdemir/Fare-Oyunu) | 🟢 **Güncel** |
| **21** | **Kaçak Dizi (media-stream-agent)** | Akıllı Medya Akış & İndirme Ajanı | ❌ Hayır | [oguztasdemir/media-stream-agent](https://github.com/oguztasdemir/media-stream-agent) | 🟢 **Güncel** |
| **22** | **Kripto Projesi (crypto-analytics)** | Çok Modlu Kripto Analiz & AI Persona Motoru | ❌ Hayır | [oguztasdemir/crypto-analytics-engine](https://github.com/oguztasdemir/crypto-analytics-engine) | 🟢 **Güncel** |
| **23** | **GitHub Profil Vitrini** | Özel Profil README & Biyografi Deposu | 👤 Profil | [oguztasdemir/oguztasdemir](https://github.com/oguztasdemir/oguztasdemir) | 🟢 **Güncel** |

---

## 🔒 2. Özel / Gizli (Private) Ar-Ge Projeleri

Bu projeler fikri mülkiyet, Ar-Ge ve özel mimari içeren; yalnızca sizin erişebildiğiniz gizli depolardır:
...
## 🛡️ Güvenlik Yedeği Bilgisi
* Tüm GitHub verileriniz, 35 canlı repo README'niz ve portfolyo JSON dosyalarınız `C:\Users\User\Desktop\Github yedek` klasöründe tam güvenlik yedeğiyle korunmaktadır.
