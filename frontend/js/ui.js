  ...
  renderProjectDetail(rawProject, container, onSelectProject, allProjects = [], initialTab = null) {
    ...
    const getProjectWhyStory = () => {
      ...
      const storiesTr = {
        ...
        'kpss-sinav-hazirlik': 'KPSS sınavına hazırlanırken kalın test kitaplarını taşımak yerine dijital ortamda çalışabilmek; hem kendi hazırlığımda hem de sınava hazırlanan arkadaşlarımın isteği üzerine birlikte soru çözebilmemiz için geliştirdiğim Vercel üzerinde canlı hazırlık platformudur.',
